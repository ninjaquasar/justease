        ...
        <>
            ...
            <main className="px-44 flex flex-col gap-y-10 items-center justify-center min-h-[85vh]">
                ...
                <div className="space-y-4 text-center">
                    ...
                    <Link to='/' className="px-6 py-3 flex items-center place-self-center gap-x-2 text-2xl font-semibold bg-primary rounded-lg w-fit cursor-grenade"><Home size={28}></Home> Go Back Home</Link>
                </div>
            </main>
        </>
    )
