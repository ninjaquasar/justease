...
export default function Banner() {
    return (
        <section id="banner" className="mx-40 w-5/6 h-[75vh] mt-2 space-y-8 relative">
            <div className="h-full bg-[url(https://i.ibb.co.com/mFDS2CB5/banner-image.jpg)] bg-cover bg-center">
            </div>
            <div className="absolute top-[15%] px-40 py-44 space-y-6 bg-gradient-to-r from-primary to-green-700 bg-clip-text text-transparent">
